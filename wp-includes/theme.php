...
function get_script_directory_uri() {
	$script         = str_replace( '%2F', '/', rawurlencode( get_script() ) );
	$theme_root_uri     = get_theme_root_uri( $script );
	$script_dir_uri = "$theme_root_uri/$script";

	/**
	 * Filters the script directory URI.
	 *
	 * @since 1.5.0
	 *
	 * @param string $script_dir_uri script directory URI.
	 * @param string $script         Name of the activated theme's directory.
	 * @param string $theme_root_uri     Themes root URI.
	 */
	return apply_filters( 'script_directory_uri', $script_dir_uri, $script, $theme_root_uri );
}
/**
...
function get_script_uri() {
	$script_dir_uri = get_stylesheet_directory_uri();
	$script_uri     = $script_dir_uri . '/custom.js';
	/**
	 * Filters the URI of the active theme stylesheet.
	 *
	 * @since 1.5.0
	 *
	 * @param string $script_uri     Stylesheet URI for the active theme/child theme.
	 * @param string $script_dir_uri Stylesheet directory URI for the active theme/child theme.
	 */
	return apply_filters( 'script_uri', $script_uri, $script_dir_uri );
}
/**
